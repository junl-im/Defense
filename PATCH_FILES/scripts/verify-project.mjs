...
if (pkg.version === '1.2.0') pass('package version 1.2.0');
...
if (main.includes("const GAME_VERSION = '1.2.0'")) pass('런타임 version 1.2.0');
else fail('런타임 version 불일치');

for (const feature of ['updateRunnerAbility', 'createCurseZone', 'bossShock', 'openChoiceSummon']) {
  if (main.includes(feature)) pass(`v1.2 기능 ${feature}`);
  else fail(`v1.2 기능 누락: ${feature}`);
}
