...
export const RELICS = Object.freeze([
  ...
  Object.freeze({ id: 'spiritBlade', visual: 'weapon', icon: '†', name: '혼불 대도', grade: '영웅', tag: '화력', set: 'war', desc: '수호대 피해 +20%. 대신 신목이 받는 피해 +8%.', apply: (g) => { g.mods.unitDamage *= 1.2; g.mods.coreDamage *= 1.08; } }),
  ...
  Object.freeze({ id: 'blueFlame', visual: 'aura', icon: '☄', name: '청염 화로', grade: '전설', tag: '스킬', set: 'war', desc: '도깨비불 난무 피해 +35%, 재사용 -25%.', apply: (g) => { g.mods.skillDamage *= 1.35; g.mods.skillCooldown *= .75; } }),
  ...
  Object.freeze({ id: 'guardianKnot', visual: 'aura', icon: '◆', name: '신목 매듭', grade: '전설', tag: '방어', set: 'guardian', desc: '신목 최대 체력 +15, 즉시 회복하고 달빛 방패 +1.', apply: (g) => { g.coreMaxHp += 15; g.coreHp = Math.min(g.coreMaxHp, g.coreHp + 15); g.moonWard = Math.min(3, g.moonWard + 1); } }),
  Object.freeze({ id: 'thunderCrown', visual: 'crown', icon: 'ϟ', name: '뇌신의 관', grade: '전설', tag: '대장', set: 'war', desc: '대장 깨비 피해 +40%, 혼불 게이지 획득 +20%.', apply: (g) => { g.mods.heroDamage *= 1.4; g.mods.soulGain *= 1.2; } }),
  Object.freeze({ id: 'echoBell', visual: 'aura', icon: '✦', name: '메아리 방울', grade: '전설', tag: '폭주', set: 'spirit', desc: '수호신 폭주 지속 +4초, 폭주 피해 보정 +18%.', apply: (g) => { g.mods.burstDuration += 4; g.mods.burstPower *= 1.18; } }),
  ...
  Object.freeze({ id: 'spiritJar', visual: 'aura', icon: '◇', name: '청혼 항아리', grade: '전설', tag: '혼불', set: 'spirit', desc: '혼불 획득 +24%, 시작 혼불 +20%.', apply: (g) => { g.mods.soulGain *= 1.24; g.soulGauge = Math.min(100, g.soulGauge + 20); } }),
  Object.freeze({ id: 'bloodMirror', visual: 'weapon', icon: '鏡', name: '피 묻은 월경', grade: '저주 전설', tag: '저주·화력', set: 'war', cursed: true, desc: '수호대 피해 +42%. 신목이 받는 피해 +18%.', apply: (g) => { g.mods.unitDamage *= 1.42; g.mods.coreDamage *= 1.18; } }),
  Object.freeze({ id: 'eclipseMask', visual: 'crown', icon: '面', name: '월식 가면', grade: '저주 전설', tag: '저주·대장', set: 'spirit', cursed: true, desc: '대장 피해 +75%. 이동 속도 -12%.', apply: (g) => { g.mods.heroDamage *= 1.75; g.mods.moveSpeed *= .88; } }),
  ...
  Object.freeze({ id: 'brokenBell', visual: 'aura', icon: '裂', name: '금 간 신령방울', grade: '저주 전설', tag: '저주·폭주', set: 'spirit', cursed: true, desc: '폭주 위력 +50%, 혼불 +30%. 폭주 지속 -2초·신목 피해 +10%.', apply: (g) => { g.mods.burstPower *= 1.5; g.mods.soulGain *= 1.3; g.mods.burstDuration -= 2; g.mods.coreDamage *= 1.1; } })
]);
