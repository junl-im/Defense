...
export const HERO_CLASSES = Object.freeze({
  warrior: Object.freeze({
    ...
    icon: 'assets/ui/v390/class-warrior.png', color: 0x69edff, accent: '#ffd978',
  ...
  archer: Object.freeze({
    ...
    icon: 'assets/ui/v390/class-archer.png', color: 0x8ff3b2, accent: '#baffd1',
  ...
  mage: Object.freeze({
    ...
    icon: 'assets/ui/v390/class-mage.png', color: 0xa881ff, accent: '#8feeff',
