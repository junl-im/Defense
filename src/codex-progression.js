...
export const ENEMY_RESEARCH = Object.freeze({
  ...
  ghost: Object.freeze({ weakTo: 'bell', multiplier: 1.25, title: '혼백을 깨우는 방울', tip: '달그림자 귀신은 방울 파동에 형체가 고정되어 큰 피해를 받습니다.' }),
  skeleton: Object.freeze({ weakTo: 'stone', multiplier: 1.23, title: '백골 갑주 파쇄', tip: '바위 충격으로 낡은 방패와 뼈 마디를 동시에 깨뜨립니다.' }),
  crow: Object.freeze({ weakTo: 'wind', multiplier: 1.24, title: '날개를 가르는 천풍', tip: '빠르게 우회하는 까마귀는 관통 바람에 날개 균형을 잃습니다.' }),
...
export const LOOT_CATALOG = Object.freeze({
  ...
  'moon-ectoplasm': Object.freeze({ icon: '魂', name: '달빛 혼백', rarity: 'common', shards: 2, copy: '달그림자 귀신이 남긴 맑은 혼백 조각.' }),
  'bone-shield-chip': Object.freeze({ icon: '骨', name: '백골 방패편', rarity: 'common', shards: 2, copy: '백골 무사의 방패에서 떨어진 상아색 파편.' }),
  'storm-feather': Object.freeze({ icon: '羽', name: '먹구름 깃', rarity: 'common', shards: 1, copy: '보라 번개 냄새가 남은 까마귀 깃털.' }),
...
export const ENEMY_LOOT_TABLES = Object.freeze({
  ...
  ghost: Object.freeze([{ id: 'moon-ectoplasm', chance: .17 }]),
  skeleton: Object.freeze([{ id: 'bone-shield-chip', chance: .16 }]),
  crow: Object.freeze([{ id: 'storm-feather', chance: .18 }]),
