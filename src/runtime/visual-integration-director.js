export const VISUAL_INTEGRATION_VERSION = '20.0.0';
...
export default class VisualIntegrationDirector {
  ...
  install() {
    ...
    probe.src = matchMedia('(max-width:720px),(orientation:portrait)').matches
      ? './src/assets/title-v17/title-bg-mobile-v17.webp?v=20.0.0'
      : './src/assets/title-v17/title-bg-desktop-v17.webp?v=20.0.0';
