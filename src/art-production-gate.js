...
export const ART_PRODUCTION_GATE_VERSION = '5.0.0';
export const GOLDEN_VERTICAL_SLICE_ID = 'DD-GVS-001';

export const GOLDEN_VERTICAL_SLICE = Object.freeze([
  Object.freeze({ id: 'GVS-HERO-WARRIOR', category: 'hero', label: '도깨비 전사', status: 'dna-locked', completion: 35, required: true }),
  Object.freeze({ id: 'GVS-MONSTER-GRUNT', category: 'monster', label: '일반 요괴', status: 'spec-ready', completion: 20, required: true }),
  Object.freeze({ id: 'GVS-BOSS-TIGER', category: 'boss', label: '저승 호랑이', status: 'spec-ready', completion: 20, required: true }),
  Object.freeze({ id: 'GVS-ENV-MOON-MARKET', category: 'environment', label: '도깨비마을 전장', status: 'runtime-remaster', completion: 30, required: true }),
  Object.freeze({ id: 'GVS-UI-COMBAT', category: 'ui', label: '전투 HUD', status: 'runtime-remaster', completion: 55, required: true }),
  Object.freeze({ id: 'GVS-VFX-COMBAT', category: 'vfx', label: '전투 VFX', status: 'runtime-remaster', completion: 40, required: true })
]);
...
export const MASSIVE_UPDATE_MILESTONES = Object.freeze([
  ...
  Object.freeze({ id: 'M3', label: 'Engine 4.0 적응형 품질·프레임 예산', status: 'done' }),
  Object.freeze({ id: 'M4', label: '골든 전사 신규 제작·실기기 승인', status: 'active' }),
  Object.freeze({ id: 'M5', label: '요괴·보스·환경 최종 에셋 교체', status: 'next' }),
  Object.freeze({ id: 'M6', label: '1,130개 승인 DNA 대량 생산', status: 'next' })
]);
