...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.image('v1-login-clean-bg', 'assets/backgrounds/login_background_clean_v2_15.png');
    this.load.image('v1-title-logo-clean', 'assets/ui/title_logo_v1_9.png');
    this.load.image('v1-login-panel-v18', 'assets/ui/v2_15/login_panel_v2_15.png');
    this.load.image('v1-login-button-gold-v18', 'assets/ui/v2_15/login_button_gold_v2_15.png');
    this.load.image('v1-login-button-white-v18', 'assets/ui/v2_15/login_button_white_v2_15.png');
    this.load.image('v1-login-button-small-v18', 'assets/ui/v2_15/login_button_small_v2_15.png');
    this.load.image('v1-login-utility-button-v18', 'assets/ui/v2_15/login_utility_button_v2_15.png');
    this.load.image('v1-main-menu-splash-v18', 'assets/backgrounds/main_menu_splash_v2_15.png');
    this.load.image('v1-worldmap-splash-v18', 'assets/backgrounds/worldmap_splash_v2_15.png');
    ...
    this.load.image('v1-combat-top-hud', 'assets/ui/v2_15/combat_top_hud_v2_15.png');
    this.load.image('v1-combat-bottom-dock', 'assets/ui/v2_15/combat_bottom_dock_v2_15.png');
    this.load.image('v1-tower-build-menu', 'assets/ui/v2_15/tower_build_menu_v2_15.png');
    this.load.image('v1-tower-build-card', 'assets/ui/v2_15/tower_build_card_v2_15.png');
    this.load.image('v1-tower-command-panel', 'assets/ui/v2_15/tower_command_panel_v2_15.png');
    ...
    this.load.image('v1-button-green', 'assets/ui/v2_15/button_green_v2_15.png');

    // v2.2: visual sync / QA overlays. These are clean art layers with no baked text.
    this.load.image('v2-combat-focus-overlay', 'assets/ui/v2_15/combat_focus_overlay_v2_15.png');
    this.load.image('v2-path-waypoint', 'assets/ui/v2_2/path_waypoint_v2_2.png');
    this.load.image('v2-tower-selection-ring', 'assets/ui/v2_15/tower_selection_ring_v2_15.png');
    ...
    this.load.image('v217-dreamy-panel-wide', 'assets/ui/v2_17/dreamy_panel_wide_v2_17.png');
    this.load.image('v217-dreamy-panel-small', 'assets/ui/v2_17/dreamy_panel_small_v2_17.png');
    this.load.image('v217-checklist-card', 'assets/ui/v2_17/checklist_card_v2_17.png');
    this.load.image('v217-title-banner', 'assets/ui/v2_17/title_banner_v2_17.png');
    this.load.image('v217-soft-banner-blue', 'assets/ui/v2_17/soft_banner_blue_v2_17.png');
    this.load.image('v217-button-gold-squish', 'assets/ui/v2_17/button_gold_squish_v2_17.png');
    this.load.image('v217-button-blue-squish', 'assets/ui/v2_17/button_blue_squish_v2_17.png');
    this.load.image('v217-nav-pill', 'assets/ui/v2_17/nav_pill_v2_17.png');
    this.load.image('v217-resource-chip', 'assets/ui/v2_17/resource_chip_v2_17.png');
    this.load.image('v217-shop-tag', 'assets/ui/v2_17/shop_tag_v2_17.png');
    this.load.image('v217-stage-frame', 'assets/ui/v2_17/stage_frame_v2_17.png');
    this.load.image('v217-stage-lock', 'assets/ui/v2_17/stage_lock_v2_17.png');
    this.load.image('v217-stage-route-dot', 'assets/ui/v2_17/stage_route_dot_v2_17.png');
    this.load.image('v217-stage-selected-halo', 'assets/ui/v2_17/stage_selected_halo_v2_17.png');
    this.load.image('v217-battle-top-badge', 'assets/ui/v2_17/battle_top_badge_v2_17.png');
    this.load.image('v217-battle-bottom-cushion', 'assets/ui/v2_17/battle_bottom_cushion_v2_17.png');
    this.load.image('v217-wave-hint-panel', 'assets/ui/v2_17/wave_hint_panel_v2_17.png');
    this.load.image('v217-toast-bubble', 'assets/ui/v2_17/toast_bubble_v2_17.png');
    this.load.image('v217-spell-card-meteor', 'assets/ui/v2_17/spell_card_meteor_v2_17.png');
    this.load.image('v217-spell-card-guard', 'assets/ui/v2_17/spell_card_guard_v2_17.png');
    this.load.image('v217-spell-card-hero', 'assets/ui/v2_17/spell_card_hero_v2_17.png');
    this.load.image('v217-mascot-fairy', 'assets/ui/v2_17/mascot_fairy_v2_17.png');
    this.load.image('v217-mascot-slime', 'assets/ui/v2_17/mascot_slime_v2_17.png');
    this.load.image('v217-mascot-tower', 'assets/ui/v2_17/mascot_tower_v2_17.png');
    this.load.image('v217-sparkle-cluster', 'assets/ui/v2_17/sparkle_cluster_v2_17.png');
    this.load.image('v217-flower-corner', 'assets/ui/v2_17/flower_corner_v2_17.png');
    this.load.image('v217-leaf-vine', 'assets/ui/v2_17/leaf_vine_v2_17.png');
    this.load.image('v217-gem-cluster', 'assets/ui/v2_17/gem_cluster_v2_17.png');
    this.load.image('v217-soft-divider', 'assets/ui/v2_17/soft_divider_v2_17.png');
    this.load.image('v217-alert-badge', 'assets/ui/v2_17/alert_badge_v2_17.png');
    ...
    this.load.image('v217-badge-heart', 'assets/ui/v2_17/badge_heart_v2_17.png');
    ...
    this.load.image('v218-plush-modal-frame', 'assets/ui/v2_18/plush_modal_frame_v2_18.png');
    this.load.image('v218-nursery-header-ribbon', 'assets/ui/v2_18/nursery_header_ribbon_v2_18.png');
    this.load.image('v218-scallop-button-gold', 'assets/ui/v2_18/scallop_button_gold_v2_18.png');
    this.load.image('v218-scallop-button-blue', 'assets/ui/v2_18/scallop_button_blue_v2_18.png');
    this.load.image('v218-scallop-button-pink', 'assets/ui/v2_18/scallop_button_pink_v2_18.png');
    this.load.image('v218-login-cloud-arch', 'assets/ui/v2_18/login_cloud_arch_v2_18.png');
    this.load.image('v218-login-stamp-quick', 'assets/ui/v2_18/login_stamp_quick_v2_18.png');
    this.load.image('v218-login-stamp-google', 'assets/ui/v2_18/login_stamp_google_v2_18.png');
    this.load.image('v218-fairy-house', 'assets/ui/v2_18/fairy_house_v2_18.png');
    this.load.image('v218-slime-crown', 'assets/ui/v2_18/slime_crown_v2_18.png');
    this.load.image('v218-acorn-shield', 'assets/ui/v2_18/acorn_shield_v2_18.png');
    this.load.image('v218-little-sword-badge', 'assets/ui/v2_18/little_sword_badge_v2_18.png');
    this.load.image('v218-resource-shell-coin', 'assets/ui/v2_18/resource_shell_coin_v2_18.png');
    this.load.image('v218-resource-shell-gem', 'assets/ui/v2_18/resource_shell_gem_v2_18.png');
    this.load.image('v218-resource-shell-heart', 'assets/ui/v2_18/resource_shell_heart_v2_18.png');
    this.load.image('v218-lobby-quest-scroll', 'assets/ui/v2_18/lobby_quest_scroll_v2_18.png');
    this.load.image('v218-lobby-shop-awning', 'assets/ui/v2_18/lobby_shop_awning_v2_18.png');
    this.load.image('v218-worldmap-path-bridge', 'assets/ui/v2_18/worldmap_path_bridge_v2_18.png');
    this.load.image('v218-worldmap-node-crown', 'assets/ui/v2_18/worldmap_node_crown_v2_18.png');
    this.load.image('v218-worldmap-preview-frame', 'assets/ui/v2_18/worldmap_preview_frame_v2_18.png');
    this.load.image('v218-worldmap-cloud-island', 'assets/ui/v2_18/worldmap_cloud_island_v2_18.png');
    this.load.image('v218-battle-hud-lace-top', 'assets/ui/v2_18/battle_hud_lace_top_v2_18.png');
    this.load.image('v218-battle-skill-tray', 'assets/ui/v2_18/battle_skill_tray_v2_18.png');
    this.load.image('v218-battle-wave-flag', 'assets/ui/v2_18/battle_wave_flag_v2_18.png');
    this.load.image('v218-battle-corner-leaf', 'assets/ui/v2_18/battle_corner_leaf_v2_18.png');
    this.load.image('v218-battle-spell-meteor-orb', 'assets/ui/v2_18/battle_spell_meteor_orb_v2_18.png');
    this.load.image('v218-battle-spell-guard-orb', 'assets/ui/v2_18/battle_spell_guard_orb_v2_18.png');
    this.load.image('v218-battle-spell-hero-orb', 'assets/ui/v2_18/battle_spell_hero_orb_v2_18.png');
    this.load.image('v218-tiny-star-spray', 'assets/ui/v2_18/tiny_star_spray_v2_18.png');
    this.load.image('v218-tiny-heart-spray', 'assets/ui/v2_18/tiny_heart_spray_v2_18.png');
    this.load.image('v218-tiny-leaf-spray', 'assets/ui/v2_18/tiny_leaf_spray_v2_18.png');
    this.load.image('v218-toast-marshmallow', 'assets/ui/v2_18/toast_marshmallow_v2_18.png');
    this.load.image('v218-progress-bead', 'assets/ui/v2_18/progress_bead_v2_18.png');
    this.load.image('v218-selected-stage-glow', 'assets/ui/v2_18/selected_stage_glow_v2_18.png');
    this.load.image('v218-locked-stage-padlock', 'assets/ui/v2_18/locked_stage_padlock_v2_18.png');
    this.load.image('v218-fairy-wing-pair', 'assets/ui/v2_18/fairy_wing_pair_v2_18.png');
    this.load.image('v218-mascot-bunny', 'assets/ui/v2_18/mascot_bunny_v2_18.png');
    this.load.image('v218-mascot-puff-dragon', 'assets/ui/v2_18/mascot_puff_dragon_v2_18.png');
    this.load.image('v218-mobile-thumb-hint', 'assets/ui/v2_18/mobile_thumb_hint_v2_18.png');
    this.load.image('v218-settings-cog-soft', 'assets/ui/v2_18/settings_cog_soft_v2_18.png');
    this.load.image('v218-mail-heart-icon', 'assets/ui/v2_18/mail_heart_icon_v2_18.png');
    this.load.image('v218-gmark-soft-icon', 'assets/ui/v2_18/gmark_soft_icon_v2_18.png');
    this.load.image('v218-gold-ticket', 'assets/ui/v2_18/gold_ticket_v2_18.png');
    this.load.image('v218-blue-ticket', 'assets/ui/v2_18/blue_ticket_v2_18.png');

    // v2.19: storybook massive art pass. Transparent UI assets are WebP-swapped by the optimized raster pipeline.
    this.load.image('v219-account-crest', 'assets/ui/v2_19/account_crest_v2_19.png');
    ...
    this.load.image('v219-battle-build-spot-glow', 'assets/ui/v2_19/battle_build_spot_glow_v2_19.png');
    this.load.image('v219-battle-combo-cookie', 'assets/ui/v2_19/battle_combo_cookie_v2_19.png');
    this.load.image('v219-battle-safe-corner', 'assets/ui/v2_19/battle_safe_corner_v2_19.png');
    this.load.image('v219-battle-side-mana-vine', 'assets/ui/v2_19/battle_side_mana_vine_v2_19.png');
    this.load.image('v219-battle-spell-card-guard', 'assets/ui/v2_19/battle_spell_card_guard_v2_19.png');
    this.load.image('v219-battle-spell-card-hero', 'assets/ui/v2_19/battle_spell_card_hero_v2_19.png');
    this.load.image('v219-battle-spell-card-meteor', 'assets/ui/v2_19/battle_spell_card_meteor_v2_19.png');
    this.load.image('v219-battle-spell-card-plush', 'assets/ui/v2_19/battle_spell_card_plush_v2_19.png');
    this.load.image('v219-battle-spell-guard-badge', 'assets/ui/v2_19/battle_spell_guard_badge_v2_19.png');
    this.load.image('v219-battle-spell-hero-badge', 'assets/ui/v2_19/battle_spell_hero_badge_v2_19.png');
    this.load.image('v219-battle-spell-meteor-badge', 'assets/ui/v2_19/battle_spell_meteor_badge_v2_19.png');
    this.load.image('v219-battle-top-story-lace', 'assets/ui/v2_19/battle_top_story_lace_v2_19.png');
    this.load.image('v219-battle-wave-bookmark', 'assets/ui/v2_19/battle_wave_bookmark_v2_19.png');
    this.load.image('v219-castle-banner-ribbon', 'assets/ui/v2_19/castle_banner_ribbon_v2_19.png');
    this.load.image('v219-floating-music-note', 'assets/ui/v2_19/floating_music_note_v2_19.png');
    this.load.image('v219-heart-leaf-confetti', 'assets/ui/v2_19/heart_leaf_confetti_v2_19.png');
    this.load.image('v219-lobby-bottom-nav-glow', 'assets/ui/v2_19/lobby_bottom_nav_glow_v2_19.png');
    this.load.image('v219-lobby-castle-banner', 'assets/ui/v2_19/lobby_castle_banner_v2_19.png');
    this.load.image('v219-lobby-daily-stamp', 'assets/ui/v2_19/lobby_daily_stamp_v2_19.png');
    this.load.image('v219-lobby-event-rosette', 'assets/ui/v2_19/lobby_event_rosette_v2_19.png');
    this.load.image('v219-lobby-hero-portrait', 'assets/ui/v2_19/lobby_hero_portrait_v2_19.png');
    this.load.image('v219-lobby-mail-bubble', 'assets/ui/v2_19/lobby_mail_bubble_v2_19.png');
    this.load.image('v219-lobby-shop-sign', 'assets/ui/v2_19/lobby_shop_sign_v2_19.png');
    this.load.image('v219-lobby-tower-portrait', 'assets/ui/v2_19/lobby_tower_portrait_v2_19.png');
    this.load.image('v219-login-button-glow-google', 'assets/ui/v2_19/login_button_glow_google_v2_19.png');
    this.load.image('v219-login-button-glow-quick', 'assets/ui/v2_19/login_button_glow_quick_v2_19.png');
    this.load.image('v219-login-lantern-arch', 'assets/ui/v2_19/login_lantern_arch_v2_19.png');
    this.load.image('v219-magic-key-badge', 'assets/ui/v2_19/magic_key_badge_v2_19.png');
    this.load.image('v219-mascot-cookie-golem', 'assets/ui/v2_19/mascot_cookie_golem_v2_19.png');
    this.load.image('v219-mascot-sprout-keeper', 'assets/ui/v2_19/mascot_sprout_keeper_v2_19.png');
    this.load.image('v219-modal-soft-footer', 'assets/ui/v2_19/modal_soft_footer_v2_19.png');
    this.load.image('v219-npc-pudding-slime', 'assets/ui/v2_19/npc_pudding_slime_v2_19.png');
    this.load.image('v219-npc-sheep-mage', 'assets/ui/v2_19/npc_sheep_mage_v2_19.png');
    this.load.image('v219-npc-squirrel-archer', 'assets/ui/v2_19/npc_squirrel_archer_v2_19.png');
    this.load.image('v219-plush-button-idle', 'assets/ui/v2_19/plush_button_idle_v2_19.png');
    this.load.image('v219-plush-button-pressed', 'assets/ui/v2_19/plush_button_pressed_v2_19.png');
    this.load.image('v219-plush-cloud-backdrop', 'assets/ui/v2_19/plush_cloud_backdrop_v2_19.png');
    this.load.image('v219-progress-story-beads', 'assets/ui/v2_19/progress_story_beads_v2_19.png');
    this.load.image('v219-resource-coin-shell', 'assets/ui/v2_19/resource_coin_shell_v2_19.png');
    this.load.image('v219-resource-gem-shell', 'assets/ui/v2_19/resource_gem_shell_v2_19.png');
    this.load.image('v219-resource-star-shell', 'assets/ui/v2_19/resource_star_shell_v2_19.png');
    this.load.image('v219-ribbon-tiny-tail', 'assets/ui/v2_19/ribbon_tiny_tail_v2_19.png');
    this.load.image('v219-settings-wand', 'assets/ui/v2_19/settings_wand_v2_19.png');
    this.load.image('v219-sparkle-bloom-cluster', 'assets/ui/v2_19/sparkle_bloom_cluster_v2_19.png');
    this.load.image('v219-storybook-title-plaque', 'assets/ui/v2_19/storybook_title_plaque_v2_19.png');
    this.load.image('v219-tiny-star-trail', 'assets/ui/v2_19/tiny_star_trail_v2_19.png');
    this.load.image('v219-toast-storybook', 'assets/ui/v2_19/toast_storybook_v2_19.png');
    this.load.image('v219-tower-upgrade-sparkle', 'assets/ui/v2_19/tower_upgrade_sparkle_v2_19.png');
    this.load.image('v219-tutorial-finger-swipe', 'assets/ui/v2_19/tutorial_finger_swipe_v2_19.png');
    this.load.image('v219-world-boss-gate', 'assets/ui/v2_19/world_boss_gate_v2_19.png');
    this.load.image('v219-world-cloud-trail', 'assets/ui/v2_19/world_cloud_trail_v2_19.png');
    this.load.image('v219-world-compass-badge', 'assets/ui/v2_19/world_compass_badge_v2_19.png');
    this.load.image('v219-world-node-bloom', 'assets/ui/v2_19/world_node_bloom_v2_19.png');
    this.load.image('v219-world-node-locked-cover', 'assets/ui/v2_19/world_node_locked_cover_v2_19.png');
    this.load.image('v219-world-preview-storybook-frame', 'assets/ui/v2_19/world_preview_storybook_frame_v2_19.png');
    this.load.image('v219-world-route-dotted-ribbon', 'assets/ui/v2_19/world_route_dotted_ribbon_v2_19.png');
    this.load.image('v219-world-route-ribbon', 'assets/ui/v2_19/world_route_ribbon_v2_19.png');
    this.load.image('v219-world-stage-flag', 'assets/ui/v2_19/world_stage_flag_v2_19.png');
    this.load.image('v220-battle-boss-warning-rosette', 'assets/ui/v2_20/battle_boss_warning_rosette_v2_20.png');
    this.load.image('v220-battle-bottom-pillow-dock', 'assets/ui/v2_20/battle_bottom_pillow_dock_v2_20.png');
    this.load.image('v220-battle-build-seed-glow', 'assets/ui/v2_20/battle_build_seed_glow_v2_20.png');
    this.load.image('v220-battle-combo-jelly', 'assets/ui/v2_20/battle_combo_jelly_v2_20.png');
    this.load.image('v220-battle-guard-orb', 'assets/ui/v2_20/battle_guard_orb_v2_20.png');
    this.load.image('v220-battle-hero-orb', 'assets/ui/v2_20/battle_hero_orb_v2_20.png');
    this.load.image('v220-battle-left-flower-rail', 'assets/ui/v2_20/battle_left_flower_rail_v2_20.png');
    this.load.image('v220-battle-mana-leaf-droplets', 'assets/ui/v2_20/battle_mana_leaf_droplets_v2_20.png');
    this.load.image('v220-battle-meteor-orb', 'assets/ui/v2_20/battle_meteor_orb_v2_20.png');
    this.load.image('v220-battle-right-flower-rail', 'assets/ui/v2_20/battle_right_flower_rail_v2_20.png');
    this.load.image('v220-battle-safe-petal-corner', 'assets/ui/v2_20/battle_safe_petal_corner_v2_20.png');
    this.load.image('v220-battle-spell-card-guard-dream', 'assets/ui/v2_20/battle_spell_card_guard_dream_v2_20.png');
    this.load.image('v220-battle-spell-card-hero-dream', 'assets/ui/v2_20/battle_spell_card_hero_dream_v2_20.png');
    this.load.image('v220-battle-spell-card-meteor-dream', 'assets/ui/v2_20/battle_spell_card_meteor_dream_v2_20.png');
    this.load.image('v220-battle-top-castle-lace', 'assets/ui/v2_20/battle_top_castle_lace_v2_20.png');
    this.load.image('v220-battle-wave-teacup', 'assets/ui/v2_20/battle_wave_teacup_v2_20.png');
    this.load.image('v220-bottom-nav-rug', 'assets/ui/v2_20/bottom_nav_rug_v2_20.png');
    this.load.image('v220-dream-cloud-arch', 'assets/ui/v2_20/dream_cloud_arch_v2_20.png');
    this.load.image('v220-floating-wish-stars', 'assets/ui/v2_20/floating_wish_stars_v2_20.png');
    this.load.image('v220-lobby-event-balloon', 'assets/ui/v2_20/lobby_event_balloon_v2_20.png');
    this.load.image('v220-lobby-garden-gate', 'assets/ui/v2_20/lobby_garden_gate_v2_20.png');
    this.load.image('v220-lobby-hero-medallion', 'assets/ui/v2_20/lobby_hero_medallion_v2_20.png');
    this.load.image('v220-lobby-mail-bird', 'assets/ui/v2_20/lobby_mail_bird_v2_20.png');
    this.load.image('v220-lobby-quest-book', 'assets/ui/v2_20/lobby_quest_book_v2_20.png');
    this.load.image('v220-lobby-resource-gem-nest', 'assets/ui/v2_20/lobby_resource_gem_nest_v2_20.png');
    this.load.image('v220-lobby-resource-gold-nest', 'assets/ui/v2_20/lobby_resource_gold_nest_v2_20.png');
    this.load.image('v220-lobby-resource-heart-nest', 'assets/ui/v2_20/lobby_resource_heart_nest_v2_20.png');
    this.load.image('v220-lobby-resource-star-nest', 'assets/ui/v2_20/lobby_resource_star_nest_v2_20.png');
    this.load.image('v220-lobby-shop-tent', 'assets/ui/v2_20/lobby_shop_tent_v2_20.png');
    this.load.image('v220-lobby-tower-medallion', 'assets/ui/v2_20/lobby_tower_medallion_v2_20.png');
    this.load.image('v220-login-aurora-ribbon', 'assets/ui/v2_20/login_aurora_ribbon_v2_20.png');
    this.load.image('v220-login-card-lace-frame', 'assets/ui/v2_20/login_card_lace_frame_v2_20.png');
    this.load.image('v220-login-email-envelope-charm', 'assets/ui/v2_20/login_email_envelope_charm_v2_20.png');
    this.load.image('v220-login-google-gem-charm', 'assets/ui/v2_20/login_google_gem_charm_v2_20.png');
    this.load.image('v220-login-quick-crown-charm', 'assets/ui/v2_20/login_quick_crown_charm_v2_20.png');
    this.load.image('v220-login-register-heart-charm', 'assets/ui/v2_20/login_register_heart_charm_v2_20.png');
    this.load.image('v220-login-toy-castle-crest', 'assets/ui/v2_20/login_toy_castle_crest_v2_20.png');
    this.load.image('v220-mascot-fox-knight', 'assets/ui/v2_20/mascot_fox_knight_v2_20.png');
    this.load.image('v220-mascot-moon-kitten', 'assets/ui/v2_20/mascot_moon_kitten_v2_20.png');
    this.load.image('v220-mini-announcement-scroll', 'assets/ui/v2_20/mini_announcement_scroll_v2_20.png');
    this.load.image('v220-mini-settings-gearflower', 'assets/ui/v2_20/mini_settings_gearflower_v2_20.png');
    this.load.image('v220-mini-support-headset', 'assets/ui/v2_20/mini_support_headset_v2_20.png');
    this.load.image('v220-modal-garden-frame', 'assets/ui/v2_20/modal_garden_frame_v2_20.png');
    this.load.image('v220-npc-baker-bear', 'assets/ui/v2_20/npc_baker_bear_v2_20.png');
    this.load.image('v220-npc-seed-fairy', 'assets/ui/v2_20/npc_seed_fairy_v2_20.png');
    this.load.image('v220-npc-tea-rabbit', 'assets/ui/v2_20/npc_tea_rabbit_v2_20.png');
    this.load.image('v220-performance-feather', 'assets/ui/v2_20/performance_feather_v2_20.png');
    this.load.image('v220-qa-check-badge', 'assets/ui/v2_20/qa_check_badge_v2_20.png');
    this.load.image('v220-reward-rainbow-tray', 'assets/ui/v2_20/reward_rainbow_tray_v2_20.png');
    this.load.image('v220-soft-divider-sparkles', 'assets/ui/v2_20/soft_divider_sparkles_v2_20.png');
    this.load.image('v220-toast-garden-frame', 'assets/ui/v2_20/toast_garden_frame_v2_20.png');
    this.load.image('v220-touch-safe-badge', 'assets/ui/v2_20/touch_safe_badge_v2_20.png');
    this.load.image('v220-world-boss-portal-cake', 'assets/ui/v2_20/world_boss_portal_cake_v2_20.png');
    this.load.image('v220-world-compass-rose', 'assets/ui/v2_20/world_compass_rose_v2_20.png');
    this.load.image('v220-world-current-crown-pop', 'assets/ui/v2_20/world_current_crown_pop_v2_20.png');
    this.load.image('v220-world-locked-bow', 'assets/ui/v2_20/world_locked_bow_v2_20.png');
    this.load.image('v220-world-node-jelly-ring', 'assets/ui/v2_20/world_node_jelly_ring_v2_20.png');
    this.load.image('v220-world-parchment-map-frame', 'assets/ui/v2_20/world_parchment_map_frame_v2_20.png');
    this.load.image('v220-world-preview-garden-frame', 'assets/ui/v2_20/world_preview_garden_frame_v2_20.png');
    this.load.image('v220-world-route-candy-beads', 'assets/ui/v2_20/world_route_candy_beads_v2_20.png');
    this.load.image('v220-world-route-leaf-bridge', 'assets/ui/v2_20/world_route_leaf_bridge_v2_20.png');
    ...
    this.load.image('v2-toast-plaque-v210', 'assets/ui/v2_15/toast_plaque_v2_15.png');
    this.load.image('v2-mini-badge-gold-v211', 'assets/ui/v2_15/mini_badge_gold_v2_15.png');
    this.load.image('v2-mini-badge-green-v211', 'assets/ui/v2_15/mini_badge_green_v2_15.png');
    this.load.image('v2-lobby-strategy-card-v210', 'assets/ui/v2_15/lobby_strategy_card_v2_15.png');
    this.load.image('v2-lobby-side-button-v210', 'assets/ui/v2_15/lobby_side_button_v2_15.png');
    this.load.image('v2-resource-pill-v210', 'assets/ui/v2_15/resource_pill_v2_15.png');
    this.load.image('v1-combat-button-blue-v18', 'assets/ui/v2_15/button_blue_v2_15.png');
    this.load.image('v1-combat-button-gold-v18', 'assets/ui/v2_15/button_gold_v2_15.png');
    this.load.image('v1-combat-button-green-v18', 'assets/ui/v2_15/button_green_v2_15.png');
    this.load.image('v1-combat-button-red-v18', 'assets/ui/v2_15/button_red_v2_15.png');
    ...
    this.load.image('battle-bg-stage_001', 'assets/maps/v2_15/battle_stage_001_v2_15.png');
    this.load.image('battle-bg-stage_002', 'assets/maps/v2_15/battle_stage_002_v2_15.png');
    this.load.image('battle-bg-stage_003', 'assets/maps/v2_15/battle_stage_003_v2_15.png');
    this.load.image('battle-bg-stage_004', 'assets/maps/v2_15/battle_stage_004_v2_15.png');
    this.load.image('battle-bg-stage_005', 'assets/maps/v2_15/battle_stage_005_v2_15.png');
    this.load.image('battle-bg-stage_006', 'assets/maps/v2_15/battle_stage_006_v2_15.png');
    this.load.image('battle-bg-stage_007', 'assets/maps/v2_15/battle_stage_007_v2_15.png');
    this.load.image('battle-bg-stage_008', 'assets/maps/v2_15/battle_stage_008_v2_15.png');
    this.load.image('battle-bg-stage_009', 'assets/maps/v2_15/battle_stage_009_v2_15.png');
    this.load.image('battle-bg-stage_010', 'assets/maps/v2_15/battle_stage_010_v2_15.png');
    this.load.image('battle-bg-stage_011', 'assets/maps/v2_15/battle_stage_011_v2_15.png');
    this.load.image('battle-bg-stage_012', 'assets/maps/v2_15/battle_stage_012_v2_15.png');
    ...
    TOWER_KEYS.forEach((kind) => {
      ...
      TOWER_LEVELS.forEach((level) => {
        this.load.image(`tower-${kind}-lv${level}`, `assets/towers/v2_1/tower_${kind}_lv${level}.png`);
      });
    });

    TOWER_MASTERIES.forEach((mastery) => {
      const kind = mastery.split('_')[0];
      this.load.image(`tower-${kind}-${mastery}`, `assets/towers/v2_1/tower_${mastery}.png`);
    });
