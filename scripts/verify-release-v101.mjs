...
const checks = [
  ...
  ['core foundation director exists', foundation.includes(`CORE_FOUNDATION_VERSION = '${policy.releaseVersion}'`) && foundation.includes('sampleFrame') && foundation.includes('cadence')],
