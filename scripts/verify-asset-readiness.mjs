...
assert(ASSET_PRODUCTION_SUMMARY.characterModels === 14 && ASSET_PRODUCTION_SUMMARY.farLodDirections === 11 && ASSET_PRODUCTION_SUMMARY.integratedPrototypeAssets === 9, '에셋 생산 요약과 통합 프로토타입 9종');
