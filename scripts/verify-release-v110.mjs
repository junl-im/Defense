...
const checks = [
  ...
  ['current dist preserves directional combat visual and desktop HUD shell when present', !currentDist || ((visualIsV112 ? distMain.includes('CombatVisualDirectorV112') && distVisual.includes('authored-directional-atlas-v112') : distMain.includes('CombatVisualDirectorV110') && distVisual.includes('directional-action-projection-v110')) && distCss.includes('--desktop-hud-top-v110'))],
