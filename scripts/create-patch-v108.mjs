...
const version = '1.0.8';
const baselinePath = path.join(root, 'scripts/patch-baselines/v1.0.7.json');
...
for (const required of ['index.html', 'src/main.js', 'src/style.css', 'public/sw.js', 'scripts/verify-release-v108.mjs']) {
  if (!changedPaths.includes(required)) throw new Error(`Required v1.0.8 title exit recovery file is missing: ${required}`);
}
