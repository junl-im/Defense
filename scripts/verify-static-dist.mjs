...
if (!main.includes("const GAME_VERSION = '3.7.3'")) fail('static main version mismatch');
...
if (!catalog.includes("const ASSET_REVISION = '3.7.3'")) fail('asset cache revision missing');
if (!catalog.includes('?v=${ASSET_REVISION}')) fail('asset cache-busting URL missing');
pass('v3.7.3 asset cache revision');
