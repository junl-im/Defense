...
if (!main.includes("const GAME_VERSION = '5.0.0'")) fail('static main version mismatch');
...
if (!catalog.includes("const ASSET_REVISION = '5.0.0'")) fail('asset cache revision missing');
if (!catalog.includes('?v=${ASSET_REVISION}')) fail('asset cache-busting URL missing');
pass('v5.0.0 asset cache revision');
