...
check(pkg.version === '18.0.0', 'package version 18.0.0');
check(main.includes("const GAME_VERSION = '18.0.0'"), 'runtime game version 18.0.0');
check(ENGINE_VERSION === '15.0.0', 'engine version 15.0.0');
check(SAVE_SCHEMA_VERSION === 16, 'save schema version 16');
