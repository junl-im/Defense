...
const version = '1.0.7';
const baselinePath = path.join(root, 'scripts/patch-baselines/v1.0.6.json');
...
for (const required of ['index.html', 'src/main.js', 'src/style.css', 'src/runtime/first-presentation-director-v107.js', 'public/sw.js', 'scripts/verify-release-v107.mjs']) {
  if (!changedPaths.includes(required)) throw new Error(`Required v1.0.7 access recovery file is missing: ${required}`);
}
