...
const root=path.resolve(import.meta.dirname,'..'),name='DokkaebiLuckDefense3D_FULL_v1.0.42_SUMMON_UI_POLISH_VERIFIED',out=path.join(root,'logs/package/1.0.42'),stage=path.join(out,name);
