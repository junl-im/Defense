...
const checks=[
 ...
 ['mascot cache revision',/title-mascot-v17\.webp\?rev=(?:visible-v20|presence-v21|automation-v22|quiet-screen-v23)/.test(html)],
 ['desktop title cache revision',/title-bg-desktop-v17\.webp\?rev=(?:visible-v20|presence-v21|automation-v22|quiet-screen-v23)/.test(html)],
