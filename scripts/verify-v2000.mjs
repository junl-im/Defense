...
const checks=[
 ['package version remains v20 or later',Number(JSON.parse(read('package.json')).version.split('.')[0]) >= 20],
 ...
 ['mascot cache revision',/title-mascot-v17\.webp\?rev=(?:visible-v20|presence-v21|automation-v22|quiet-screen-v23|boot-recovery-v2301|clean-foundation-v2302|native-input-v2310)/.test(html)],
 ['desktop title cache revision',/title-bg-desktop-v17\.webp\?rev=(?:visible-v20|presence-v21|automation-v22|quiet-screen-v23|boot-recovery-v2301|clean-foundation-v2302|native-input-v2310)/.test(html)],
