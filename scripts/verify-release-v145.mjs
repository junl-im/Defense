...
check(assurance.includes('DD-LONG-SESSION-ASSURANCE-V145') && assurance.includes('maxHeapSlopeMBPer10Waves') && assurance.includes('maxFrameSlopeMsPer10Waves') && assurance.includes('normalizeLongSessionBrowserSampleV145') && assurance.includes('longTaskMsGrowth') && assurance.includes('contextExercise'), 'long-session trend model and measured long-task evidence');
check(main.includes("LongSessionAssuranceV145") && main.includes('prepareLongSessionV145') && main.includes('advanceLongSessionWaveV145') && main.includes('stabilizeLongSessionMeasurementV145') && main.includes('measureFrameWindowV145') && main.includes('longTasksDelta') && main.includes('warmupFrames') && main.includes('exerciseWebGLRecoveryV145') && main.includes('finishLongSessionV145'), 'complete game long-session test API and stable measurement window');
check(browser.includes('V145-CI-100-WAVES') && browser.includes('targetWaves:100') && browser.includes('wave===50') && browser.includes('exerciseWebGLRecoveryV145') && browser.includes('--js-flags=--expose-gc') && browser.includes('stabilizeLongSessionMeasurementV145') && browser.includes('measureFrameWindowV145(24,{warmupFrames:3})') && browser.includes('failedChecks') && browser.includes('worstFrames') && !browser.includes("if(typeof gc==='function') gc()") && browser.includes('Page.captureScreenshot') && browser.includes('Runtime.exceptionThrown') && browser.includes('Network.loadingFailed'), '100-wave Chromium harness, controlled-GC isolation, and diagnostics');
