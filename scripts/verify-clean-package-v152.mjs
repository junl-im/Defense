...
const stage = path.join(root, 'logs/package/1.0.52/DokkaebiLuckDefense3D_FULL_v1.0.52_EVENT_TIMING_RUNTIME_GUARD_CI_HOTFIX_R1');
...
console.log('PASS v1.0.52 CI hotfix R1 clean source package staging');
