...
check((html.includes('BATTLEFRONT ASCENSION') || html.includes('MYTHIC CONVERGENCE') || html.includes('GOLDEN CONVERGENCE') || html.includes('SOVEREIGN ASSEMBLY') || html.includes('GOLDEN DOMINION')) && (html.includes('ENGINE 6.0') || html.includes('ENGINE 8.0') || html.includes('ENGINE 9.0') || html.includes('ENGINE 10')) && (html.includes('v7.0.0') || html.includes('v10.0.0') || html.includes('v11.0.0') || html.includes('v12.0.0')), 'later title identity preserves battlefront lineage');
check(style.includes('--battlefront-cyan'), 'battlefront design tokens remain available');
check((consoleSource.includes('BATTLEFRONT v6') || consoleSource.includes('MYTHIC CONVERGENCE v7') || consoleSource.includes('GOLDEN CONVERGENCE v10') || consoleSource.includes('SOVEREIGN ASSEMBLY v11') || consoleSource.includes('GOLDEN DOMINION v12')) && consoleSource.includes('DOCTRINE') && consoleSource.includes('BUDGET'), 'production console preserves v6 combat diagnostics');
