...
check((html.includes('BATTLEFRONT ASCENSION') || html.includes('MYTHIC CONVERGENCE') || html.includes('GOLDEN CONVERGENCE') || html.includes('SOVEREIGN ASSEMBLY') || html.includes('GOLDEN DOMINION') || html.includes('ATLAS DOMINION')) && (html.includes('ENGINE 6.0') || html.includes('ENGINE 8.0') || html.includes('ENGINE 9.0') || html.includes('ENGINE 10') || html.includes('ENGINE 11')) && (html.includes('v7.0.0') || html.includes('v10.0.0') || html.includes('v11.0.0') || html.includes('v12.0.0') || html.includes('v13.0.0') || html.includes('v14.0.0')), 'later title identity preserves battlefront lineage');
