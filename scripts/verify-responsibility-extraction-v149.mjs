...
check(main.includes('createTransactionalPersistenceV149') && main.includes("checkpoint('finish-run')") && main.includes("checkpoint('service-worker-activated')"), 'transactional persistence lifecycle integration');
