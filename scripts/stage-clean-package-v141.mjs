...
const root=path.resolve(import.meta.dirname,'..'),name='DokkaebiLuckDefense3D_FULL_v1.0.41_TOUCH_LOADING_FIX_VERIFIED',out=path.join(root,'logs/package/1.0.41'),stage=path.join(out,name);
