...
const version = '1.0.5';
const baselinePath = path.join(root, 'scripts/patch-baselines/v1.0.4.json');
...
if (!changedPaths.includes('src/style.css')) throw new Error('The v1.0.5 title art shell requires an intentional src/style.css change.');
