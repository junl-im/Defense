...
const report = {
  ...
  titleAssets: [
    fileInfo('src/assets/title-v112/title-bg-desktop-v112.webp'),
    fileInfo('src/assets/title-v112/title-bg-mobile-v112.webp'),
    fileInfo('src/assets/title-v112/title-mascot-v112.webp')
  ],
  atlas: {
    runtimeFrames: 154,
