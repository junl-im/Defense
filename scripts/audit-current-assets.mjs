...
const document = { schemaVersion: 3, gameVersion: '14.0.0', styleLockId: ART_STYLE_LOCK_ID, legacyTechnicalStyleLockId: LEGACY_TECHNICAL_STYLE_LOCK_ID, summary, entries };
