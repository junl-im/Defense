...
assert.match(chain, /verify-ci-source-revision-v15[12]\.mjs/);
assert.match(distGate, /verify-ci-source-revision-v15[12]\.mjs/);
assert.match(workflow, /verify-ci-source-revision-v15[12]\.mjs/);
