...
if (!(pinch(15.5, -80) < 15.5)) failures.push('pinch inward must zoom in');
if (!(pinch(15.5, 80) > 15.5)) failures.push('pinch outward must zoom out');
...
const target = new THREE.Vector3(0, 1.35, 6);
const blocked = collisionDistance(target, 0, .66, 15.5, { x: 0, z: 14, radius: 2.45, height: 8.6 });
const clear = collisionDistance(target, Math.PI / 2, .66, 15.5, { x: 0, z: 14, radius: 2.45, height: 8.6 });
