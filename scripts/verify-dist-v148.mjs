...
const bundle = assertReachableBundleMarkers(dist, ['DD-RUNTIME-HEALTH-ASSURANCE-V148','unknown runtime error','fallbackEntries'], { label: 'v148 bundled runtime' });
const tasks = [
...
console.log(`PASS v1.0.48+ complete dist contains safe persistence, bounded diagnostics, hidden-frame suspension, and comprehensive audit markers under ${version.releaseVersion} (${bundle.files.length} reachable JS files)`);
