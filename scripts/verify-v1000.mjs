...
check(/const GAME_VERSION = '(?:10|11|12|13|14|15|16|17|18)\.0\.0'/.test(main), 'runtime retains v10 lineage or later');
check(Number(ENGINE_VERSION.split('.')[0]) >= 8, 'engine version remains 8.0.0 or later');
check(/ASSET_REVISION = '(?:10|11|12|13|14|15|16|17|18)\.0\.0'/.test(assetCatalog), 'asset revision remains v10 or later');
