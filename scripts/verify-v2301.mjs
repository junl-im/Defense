...
const checks = [
  ['package hotfix version 23.0.1', pkg.version === '23.0.1'],
  ['game hotfix version 23.0.1', main.includes("GAME_VERSION = '23.0.1'")],
  ['asset revision 23.0.1', catalog.includes("ASSET_REVISION = '23.0.1'")],
  ['service worker 23.0.1', sw.includes("VERSION = '23.0.1'")],
  ...
  ['static build uses recovery loader', staticBuilder.includes('static-bootstrap.js?v=23.0.1') && staticBuilder.includes('node_modules/three')],
  ...
  ['title art has hotfix cache revision', html.includes('boot-recovery-v2301')],
  ['CI verifies self-contained Vite output', workflow.includes('verify-production-bundle-v2301.mjs') && fs.existsSync('scripts/verify-production-bundle-v2301.mjs')],
