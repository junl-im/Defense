...
const checks = [
  ...
  ['title art has hotfix cache revision', (html.includes('boot-recovery-v2301') || html.includes('clean-foundation-v2302') || (html.includes('native-input-v2310') || html.includes('release-v102-b24-2') || html.includes('release-v105-b24-5')))],
