...
const bundle = assertReachableBundleMarkers(dist, ['DD-CHARACTER-ACTION-TIMING-V152', 'DD-CHARACTER-PRESENTATION-BUDGET-V152', 'DD-GPU-FRAME-TIMER-V152', 'DD-AUTHORED-DURATION-GUARD-V152', 'clearMotionHistoryV152'], { label: 'v152 bundled runtime' });
