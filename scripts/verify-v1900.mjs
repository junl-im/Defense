...
check(/const GAME_VERSION = '(?:19|20|21)\.0\.0'/.test(main), 'runtime game version 19.0.0 or later');
...
check(/const VERSION = '(?:19|20|21)\.0\.0'/.test(sw), 'service worker version 19.0.0 or later');
...
check(/const VERSION = '(?:19|20|21)\.0\.0'/.test(html), 'boot coordinator version 19.0.0 or later');
