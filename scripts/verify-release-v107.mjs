...
const checks = [
  ...
  ['static builder can vendor checked-in or installed Three runtime', buildStatic.includes("id: 'checked-in-public-vendor'") && buildStatic.includes("id: 'installed-node-module'") && buildStatic.includes('loaders/GLTFLoader.js') && (buildStatic.includes(`const version = '${version}'`) || (buildStatic.includes("const packageJson = JSON.parse") && buildStatic.includes("const version = packageJson.version")))],
