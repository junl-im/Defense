...
for(const marker of ['DD-ATOMIC-SAVE-SNAPSHOT-V150','DD-PERSISTENT-REWARD-ORCHESTRATOR-V150','DD-PRODUCTION-ERROR-BOUNDARY-V150','DD-TRANSACTIONAL-PERSISTENCE-V149'])if(!gameJs.includes(marker))throw new Error(`v150 bundled runtime marker missing: ${marker}`);
