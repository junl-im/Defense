...
if (!changedPaths.includes('src/style.css') || !changedPaths.includes('index.html')) failures.push('Title shell source changes are missing');
if (manifest.baseVersion !== '1.0.4' || manifest.targetVersion !== '1.0.5') failures.push('Patch version range mismatch');
