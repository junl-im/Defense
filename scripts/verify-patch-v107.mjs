...
for (const required of ['index.html', 'src/main.js', 'src/style.css', 'src/runtime/first-presentation-director-v107.js', 'public/sw.js', 'scripts/verify-release-v107.mjs']) {
  if (!changedPaths.includes(required)) failures.push(`required access recovery file missing: ${required}`);
}
if (manifest.baseVersion !== '1.0.6' || manifest.targetVersion !== '1.0.7') failures.push('Patch version range mismatch');
