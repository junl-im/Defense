...
check(read('src/release-identity.generated.js').includes('"releaseVersion": "1.0.50"'), 'source generated identity');
check(read('public/release-identity.generated.js').includes('"cacheRevision": "1.0.50-b24.50"'), 'public generated identity');
...
for (const [script, args] of [['scripts/bootstrap-release-package-v150.mjs',['--check']],['scripts/generate-release-identity-v150.mjs',['--check']],['scripts/generate-release-identity-v150.mjs',['--self-test']]]) {
...
console.log('PASS v1.0.50 canonical release identity and pre-verification bootstrap');
