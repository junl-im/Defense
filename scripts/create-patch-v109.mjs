...
const version = '1.0.9';
const baselinePath = path.join(root, 'scripts/patch-baselines/v1.0.8.json');
...
for (const required of ['index.html', 'src/main.js', 'src/style.css', 'src/engine/asset-catalog.js', 'src/runtime/combat-art-skin-v109.js', 'src/ui-layout-manager.js', 'public/sw.js', 'scripts/verify-release-v109.mjs']) {
  if (!changedPaths.includes(required)) throw new Error(`Required v1.0.9 combat art or desktop HUD file is missing: ${required}`);
}
