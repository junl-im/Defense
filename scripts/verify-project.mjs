...
const expectedEngineVersion = '21.0.0';
...
if (main.includes('new RenderStatsHUD') && !main.includes("code === 'F3'") && style.includes('.render-stats-hud')) pass('렌더 통계 개발 HUD 모듈 유지·전역 단축키 제거');
else fail('렌더 통계 HUD 또는 단축키 정책 오류');
