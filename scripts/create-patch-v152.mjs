...
const manifest = {
  id: 'DD-DIRECT-OVERLAY-PATCH-V152',
  baseVersion: '1.0.51',
  targetVersion: '1.0.52',
  buildId: 'b24.52',
  applyMode: 'overlay-directory-to-project-root',
  baseZipSha256: 'f2b27898e8cceb61ee7a95b7ce4505a2829d9b37753d23a89a0529d8edf21672',
