...
const outputRoot = path.join(root, 'logs/patch/1.0.38');
...
if (fs.existsSync(manifestPath)) {
  ...
  check(manifest.baseVersion === '1.0.37' && manifest.targetVersion === '1.0.38' && manifest.buildId === 'b24.38', 'patch identity');
  check(manifest.marker === 'DD-CI-PRESENTATION-SCOPE-V138', 'patch marker');
...
console.log('PASS v1.0.38 direct paste-overwrite patch hashes and structure verified');
