...
if (version.releaseVersion !== '1.0.46' || version.buildId !== 'b24.46' || version.cacheRevision !== '1.0.46-b24.46') throw new Error('v1.0.46 dist identity mismatch');
...
console.log('PASS v1.0.46 complete dist survived device traces, cache upgrade, measured trend, deterministic load phases, and localized failure digest');
