...
const baseVersion = '1.0.37';
const targetVersion = '1.0.38';
const buildId = 'b24.38';
...
const changedPaths = [
  ...
  'scripts/lib/verify-dist-presentation-surface.mjs',
  'scripts/verify-dist-v123.mjs',
  'scripts/verify-dist-v133.mjs',
  'scripts/verify-release-v137.mjs',
  'scripts/verify-dist-v137.mjs',
  'scripts/verify-release-v138.mjs',
  'scripts/verify-dist-v138.mjs',
  'scripts/stage-clean-package-v138.mjs',
  'scripts/verify-clean-package-v138.mjs',
  'scripts/create-patch-v138.mjs',
  'scripts/verify-patch-v138.mjs',
  'docs/CI_ACTIVE_PRESENTATION_CONTRACT_v1.0.38.md',
  'docs/PATCH_NOTES_v1.0.38.md',
  'docs/PATCH_APPLY_v1.0.38.md',
  'docs/NEXT_UPDATE_v1.0.39.md'
].sort();
const pkg = JSON.parse(readFileSync(path.join(root, 'package.json'), 'utf8'));
if (pkg.version !== targetVersion || pkg.dokkaebi?.buildId !== buildId) throw new Error('v1.0.38 identity is not synchronized');
...
const manifest = {
  ...
  targetVersion,
  buildId,
  marker: 'DD-CI-PRESENTATION-SCOPE-V138',
