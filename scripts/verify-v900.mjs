...
check((consoleSource.includes('IP_ASSET_LIBRARY_V9') || consoleSource.includes('IP_ASSET_LIBRARY_V10') || consoleSource.includes('IP_ASSET_LIBRARY_V13') || consoleSource.includes('IP_ASSET_LIBRARY_V14')) && (consoleSource.includes('quarantinedFragments') || consoleSource.includes('ASSET FORGE')), 'production console retains honest source and forge counts');
...
check((html.includes('asset-library-v14.html') || html.includes('asset-library-v13.html') || html.includes('asset-library-v10.html') || html.includes('asset-library-v9.html')) && (html.includes('APPROVED 0') || html.includes('PRODUCTION ART 0/6') || html.includes('3D ART 0/6')) && (html.includes('v13.0.0') || html.includes('v12.0.0') || html.includes('v13.0.0') || html.includes('v14.0.0') || html.includes('v11.0.0') || html.includes('v10.0.0') || html.includes('v9.0.0')), 'title exposes current review OS and honest zero approval count');
