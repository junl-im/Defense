...
const checks = [
  ...
  ['cache revision updated', (html.includes('native-input-v2310') || html.includes('release-v102-b24-2') || html.includes('release-v105-b24-5') || html.includes('release-v107-b24-7') || html.includes('release-v108-b24-8') || html.includes('release-v112-b24-12')) && read('src/engine/asset-catalog.js').includes("ASSET_REVISION = '23.1.0'; historical lineage marker")],
